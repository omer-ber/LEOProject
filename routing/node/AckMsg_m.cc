...
void AckMsg::copy(const AckMsg& other)
{
    ...
    this->delaySuffered = other.delaySuffered;
}
...
void AckMsg::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->delaySuffered);
}
...
void AckMsg::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->delaySuffered);
}

int AckMsg::getSrc() const
{
    return this->src;
}

void AckMsg::setSrc(int src)
{
    this->src = src;
}

long AckMsg::getAckId() const
{
    return this->ackId;
}

void AckMsg::setAckId(long ackId)
{
    this->ackId = ackId;
}

double AckMsg::getDelaySuffered() const
{
    return this->delaySuffered;
}

void AckMsg::setDelaySuffered(double delaySuffered)
{
    this->delaySuffered = delaySuffered;
}
...
unsigned int AckMsgDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_delaySuffered
    };
...
int AckMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'd' && strcmp(fieldName, "delaySuffered") == 0) return base+2;
...
std::string AckMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_delaySuffered: return double2string(pp->getDelaySuffered());
        default: return "";
    }
}
...
bool AckMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_ackId: pp->setAckId(string2long(value)); return true;
        case FIELD_delaySuffered: pp->setDelaySuffered(string2double(value)); return true;
